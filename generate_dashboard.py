...
#data-table.tbl-frozen{table-layout:fixed;width:auto;min-width:100%;}
#data-table.tbl-frozen th:nth-child(1),#data-table.tbl-frozen td:nth-child(1){position:sticky;left:0;z-index:2;width:82px;}
#data-table.tbl-frozen th:nth-child(2),#data-table.tbl-frozen td:nth-child(2){position:sticky;left:82px;z-index:2;width:88px;}
#data-table.tbl-frozen th:nth-child(3),#data-table.tbl-frozen td:nth-child(3){position:sticky;left:170px;z-index:2;width:132px;}
#data-table.tbl-frozen th:nth-child(4),#data-table.tbl-frozen td:nth-child(4){position:sticky;left:302px;z-index:2;width:188px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;box-shadow:2px 0 6px rgba(0,0,0,0.45);}
#data-table.tbl-frozen thead th:nth-child(1),#data-table.tbl-frozen thead th:nth-child(2),#data-table.tbl-frozen thead th:nth-child(3),#data-table.tbl-frozen thead th:nth-child(4){z-index:3;}
#data-table.tbl-frozen td:nth-child(1),#data-table.tbl-frozen td:nth-child(2),#data-table.tbl-frozen td:nth-child(3),#data-table.tbl-frozen td:nth-child(4){background:var(--bg);}
#data-table.tbl-frozen tr:hover td:nth-child(1),#data-table.tbl-frozen tr:hover td:nth-child(2),#data-table.tbl-frozen tr:hover td:nth-child(3),#data-table.tbl-frozen tr:hover td:nth-child(4){background:var(--bg2);}
#data-table.tbl-frozen th:nth-child(n+5):not(:last-child),#data-table.tbl-frozen td:nth-child(n+5):not(:last-child){width:62px;text-align:right;}
#data-table.tbl-frozen th:last-child,#data-table.tbl-frozen td:last-child{width:82px;}"""
