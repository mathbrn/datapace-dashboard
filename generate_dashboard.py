...
function updateBiggest(){
  ...
  sorted.forEach(function(r){
    ...
    html+='<div class="time-bar-row"><div class="time-bar-label" title="'+r.r+'">'+r.r+'</div><div class="time-bar-track"><div class="time-bar-fill" style="width:'+pct+'%;background:'+barCol+'88"></div></div><div class="time-bar-val">'+fmt(v)+'</div></div>';
  });
